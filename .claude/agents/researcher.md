...
4. Check the local codebase (Read/Grep) for existing patterns, utilities, or prior art that already solve part of the problem.
...
**Reasoning** — why this one wins: maturity vs novelty trade-off, risk, fit with the constraints above, and what would have to be true for a different option to win instead.

**Sources** — links to the material that shaped the recommendation.
